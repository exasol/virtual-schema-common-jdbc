...
class SchemaAdapterNotesTest {
    ...
    void createSchemaAdapterNotesWithAllFields() {
        ...
        assertAll(() -> assertThat(schemaAdapterNotes.getCatalogSeparator(), equalTo(CATALOG_SEPARATOR)),
                ...
                () -> assertThat(schemaAdapterNotes.storesLowerCaseIdentifiers(),
                        equalTo(STORES_LOWER_CASE_IDENTIFIERS)),
                () -> assertThat(schemaAdapterNotes.storesUpperCaseIdentifiers(),
                        equalTo(STORES_UPPER_CASE_IDENTIFIERS)),
                () -> assertThat(schemaAdapterNotes.storesMixedCaseIdentifiers(),
                        equalTo(STORES_MIXED_CASE_IDENTIFIERS)),
